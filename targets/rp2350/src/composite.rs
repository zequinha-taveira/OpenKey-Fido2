...
use device::{UsbIdentity as DeviceUsbIdentity, UsbVendorPreset};
...
pub const OPENKEY_IDENTITY: UsbIdentity = UsbIdentity::from_preset(UsbVendorPreset::OpenKey);
...
/// Família YubiKey 4/5 no modo OTP+FIDO+CCID (`0407`; `profile_rp2350::YUBIKEY_4_5`,
...
pub const ACTIVE_IDENTITY: UsbIdentity = UsbIdentity::from_preset(UsbVendorPreset::YubiKey5);
