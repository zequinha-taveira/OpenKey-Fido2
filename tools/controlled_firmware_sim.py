...
* O firmware Rust e o dispositivo virtual/emulado: o mesmo `EmbeddedAuthenticator`
  (`core/authenticator/src/authenticator.rs`) que compila para RP2350/nRF52840,
  aqui compilado para host com HAL virtual (`hal/traits`, `simulator/python/board/`).
* Emulador com HAL virtual provê GPIO/I2C/SPI/CCID/board/storage virtual —
  `python/openkey_core/src/lib.rs:11` (`SimulatedPresence`), `hal/traits/src/board_generic.rs`,
...
* `hal/traits/src/board_generic.rs` — BoardDefinition/HAL
...
class ControlledFirmwareSim:
    ...
    * **Device (firmware Rust virtual)**: `EmbeddedAuthenticator` com HAL virtual
    ...
    (`core/authenticator`, `core/ctap2`, `core/crypto`).
    ...
    def make_credential(
        ...
        *,
        ...
        (`core/ctap2`, `core/crypto`, `core/credential`) com HAL virtual.
