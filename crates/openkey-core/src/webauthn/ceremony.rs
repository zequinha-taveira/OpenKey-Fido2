...
impl WebAuthnAuthenticator {
    ...
    pub fn get_info(&self) -> Result<crate::ctap2::GetInfoResponse, Box<dyn core::error::Error>> {
    ...
    pub fn get_version(
        &self,
    ) -> Result<crate::ctap2::GetVersionResponse, Box<dyn core::error::Error>> {
    ...
    pub fn set_capabilities(&mut self, capabilities: crate::ctap2::Ctap2Capabilities) {
        self.ctap.set_capabilities(capabilities);
    }

    /// Define a fonte de user presence (check de `up`) no CTAP2 subjacente.
    pub fn set_user_presence(&mut self, presence: Option<Box<dyn crate::ctap2::UserPresence>>) {
    ...
    pub fn set_user_verification(
        &mut self,
        verification: Option<Box<dyn crate::ctap2::UserVerification>>,
    ) {
        self.ctap.set_user_verification(verification);
    }

    /// Retorna referência imutável às capacidades configuradas.
    pub fn capabilities(&self) -> &crate::ctap2::Ctap2Capabilities {
