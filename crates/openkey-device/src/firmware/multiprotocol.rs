...
use crate::firmware::yubico_management::ManagementApplet;
use crate::firmware::yubico_oath::OathApplet;
use crate::firmware::yubico_openpgp::OpenPgpApplet;
use crate::firmware::yubico_piv::PivApplet;
...
mod tests {
    use super::*;
    use crate::firmware::yubico_management::AID_YUBICO_MANAGEMENT;
    use crate::firmware::yubico_oath::AID_YUBICO_OATH;
    use crate::firmware::yubico_openpgp::{AID_OPENPGP, AID_OPENPGP_FULL};
    use crate::firmware::yubico_piv::AID_PIV;
