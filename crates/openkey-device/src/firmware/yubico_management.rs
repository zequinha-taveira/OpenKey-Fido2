...
pub fn register_yubico_applets<'a, 's>(
    ...
    oath: &'a mut crate::firmware::yubico_oath::OathApplet<'s>,
) {
...
mod tests {
    ...
    fn test_router_short_form_read_config_inline_and_oath_coexistence() {
        ...
        let mut oath_select = vec![
            ...
            0x04,
            0x00,
            crate::firmware::yubico_oath::AID_YUBICO_OATH.len() as u8,
        ];
        oath_select.extend_from_slice(crate::firmware::yubico_oath::AID_YUBICO_OATH);
